...
# ║  Fixes:                                                                    ║
# ║  1. A1: Uses event-level hazard data (cp_h), not user aggregates          ║
...
# ── A1: Event-level DML (USES HAZARD DATA) ────────────────────────────────
print("\n" + "="*78)
...
# Use cp_h (event-level hazard data) not us (user-level data)
...
print("="*78)
print("  1. A1: Uses event-level hazard data (cp_h), not user aggregates ✓")
print("  2. B2: Tests 4 feature sets (V4, V5, V4&V5, V4|V5) ✓")
print("  3. A3/A4: MSM with IPTW including treatment history ✓")
